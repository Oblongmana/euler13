...
// /// <summary>
// /// Older non-streaming version with puny memory limits. Imagine only being able to accept 20,648,880 50-digit numbers as input.
// /// </summary>
// class Euler13NonStreaming
// {
...
// 	{
// 		string uniformInput = Inputs.GetStreamingInputFromArgs(args);
